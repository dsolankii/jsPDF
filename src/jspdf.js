 ...
 * @param {boolean} [options.autoPageOrientation=true] When enabled, jsPDF swaps custom page dimensions
 * to match the selected orientation ("portrait" keeps height >= width, "landscape" keeps width >= height).
 * Disable to preserve custom dimensions as provided.
